...
from .resources.file_upload.service.service import AbstractFileUploadService


def register(_app: fastapi.FastAPI, *, upload_file: AbstractFileUploadService) -> None:
    _app.include_router(__register_service(upload_file))
